...
def initializeGui():
    ...
    GuiFrame = LabelFrame(root, text=frTitle + user,
                          padx=scrnWidth/10, pady=scrnHeight/20)
    GuiFrame.grid(column=0, row=0, padx=scrnWidth/19,
                  pady=scrnHeight/8, ipadx=scrnWidth/320, ipady=scrnHeight/19)
